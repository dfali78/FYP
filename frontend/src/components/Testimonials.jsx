      ...
      <div className="max-w-4xl mx-auto text-center">
        ...
        <div className="relative">
          ...
          <button
            ...
            className="absolute cursor-pointer left-5 top-1/2 transform -translate-y-1/2 bg-black text-white p-2 rounded-full hover:bg-gray-800 transition-colors duration-200"
          >
          ...
          <button
            ...
            className="absolute right-5 cursor-pointer top-1/2 transform -translate-y-1/2 bg-black text-white p-2 rounded-full hover:bg-gray-800 transition-colors duration-200"
          >
            <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
